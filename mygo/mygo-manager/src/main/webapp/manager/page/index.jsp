...
<link rel="stylesheet" type="text/css" href="${ctx}/manager/common/skin/qingxin/skin.css" id="layout-skin"/>
    <style type="text/css">
    	#goback:HOVER{
    		cursor: pointer;
    	}
...
<body>
			...
			<div class="layout-main-tab">
                ...
                <nav class="tab-nav">
                    <div class="tab-nav-content">
                        <a href="javascript:;" class="content-tab active" data-id="${ctx}/manager/page/home.html">首页</a>
                    </div>
                </nav>
	...
	<script type="text/javascript" src="${ctx}/manager/common/lib/jquery-1.9.0.min.js"></script>
	<script type="text/javascript" src="${ctx}/manager/common/js/sccl.js"></script>
	<script type="text/javascript" src="${ctx}/manager/common/js/sccl-util.js"></script>
</body> 
</html>