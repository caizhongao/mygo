 ...
 */
  ...
  */
  ...
  void subAppend(LoggingEvent event) {
	LoggingEvent fileEvent=new LoggingEvent(event.getFQNOfLoggerClass(), event.getLogger(), event.getLevel()," ["+TraceIdUtil.getTraceId()+"] "+event.getMessage(), event.getThrowableInformation()!=null?event.getThrowableInformation().getThrowable():null);
